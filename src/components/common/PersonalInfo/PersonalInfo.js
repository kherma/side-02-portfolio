...
const PersonalInfo = () => {
  return (
    <section className={styles.personalContainer}>
      ...
      <p className={styles.personalText}>
        Also learned back-end concepts for MERN stack. Enough to setup REST API
        with database and websocket. It makes communication easier.
      </p>
      <p className={styles.personalText}>
      ...
      <p className={styles.personalText}>
        ...
        C&#x0002B;&#x0002B;. Every single
        <q className={styles.personalQuote}>Oh my god, it works&#x00021;</q> and
        <q className={styles.personalQuote}>
